...
Si el dataset contiene menos de cinco variables por favor inclúyelas en la descripción. De lo contrario, por favor escribe con el mayor detalle posible pero mantén la descripción breve. 

Siempre incluye la **fuente**.

Para el _Estado_ de cada _dataset_ existen tres opciones:
* **ordenado** - el _dataset_ esta limpio y de manera ordenada (formato **tidy** o largo).
* **desordenado** - el _dataset_ requiere ser procesado antes de explorarlo.
* **procesado** - el _dataset_ ha sido procesado un poco y puede ser explorado como tal pero no esta en formato largo (o **tidy**). Podría utilizar un poco mas de procesamiento (¡este tipo de _datasets_ son perfectos para principiantes que quieren practicar sus habilidades de limpieza de datos también!)
